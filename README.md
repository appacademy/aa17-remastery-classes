...
This repo contains different versions of the starter code for **aa17-remastery-classes**,
...
**aa17-remastery-classes**. In the directory where you want the project to appear, simply
...
`pull` changes), create a remote `aa17-remastery-classes` repo at `https://github.com`.
